        ...
        elseif(part(tline,1:4)=='$ELM' | part(tline,1:4)=='$Ele')
            ...
            for (I=1:gmesh.nbElm)
               ...
               // pause
                ...
                case 8 then // second order Line
                    gmesh.nbLines2 = gmesh.nbLines2 + 1;
                    gmesh.LINES2 =[gmesh.LINES2; IDS(NODES_ELEM (1:3))' I];
                ...
                case 10 then // second order quadrangle (9 nodes)
                    gmesh.nbQuads9 = gmesh.nbQuads9 + 1;
                    gmesh.Quads9 = [gmesh.Quads9; IDS(NODES_ELEM (1:9))' I];
                case 11 then // 2nd order tetrahedron (10 node)
                    gmesh.nbTets10 = gmesh.nbTets10 + 1;
                    gmesh.TETS10 = [gmesh.TETS10; IDS(NODES_ELEM (1:10))' I];
                case 12 then // 2nd order hexahedron (27 nodes)
                    gmesh.nbHex27 = gmesh.nbHex27 + 1;
                    gmesh.HEXA27 =[gmesh.HEXA27; IDS(NODES_ELEM (1:27))' I];
                case 13 then // 2nd order prism (18 nodes)
                    gmesh.nbPrism18 = gmesh.nbPrism18 + 1;
                    gmesh.PRISM18 =[gmesh.PRISM18; IDS(NODES_ELEM (1:18))' I];
                case 14 then // 2nd order pyramid (14 nodes)
                    gmesh.nbPyr14 = gmesh.nbPyr14 + 1;
                    gmesh.PYRAMID14 =[gmesh.PYRAMID14; IDS(NODES_ELEM (1:14))' I];
                case 16 then // second order quadrangle (8 nodes)
                    gmesh.nbQuads8 = gmesh.nbQuads8 + 1;
                    gmesh.Quads8 = [gmesh.Quads8; IDS(NODES_ELEM (1:8))' I];
                case 17 then // 2nd order hexahedron (20 nodes)
                    gmesh.nbHex20 = gmesh.nbHex20 + 1;
                    gmesh.HEXA20 =[gmesh.HEXA20; IDS(NODES_ELEM (1:20))' I];
                case 18 then // 2nd order prism (15 nodes)
                    gmesh.nbPrism15 = gmesh.nbPrism15 + 1;
                    gmesh.PRISM15 =[gmesh.PRISM15; IDS(NODES_ELEM (1:15))' I];
                case 19 then // 2nd order pyramid (13 nodes)
                    gmesh.nbPyr13 = gmesh.nbPyr13 + 1;
                    gmesh.PYRAMID13 =[gmesh.PYRAMID13; IDS(NODES_ELEM (1:13))' I];
                else
                    disp(' ')
