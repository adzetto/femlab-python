function Ke = keq4eps(Xe,Ge,Se,Ee,stype)
...
//          plastic strain. 
//   stype : parameter setting material model
//          stype = 1 -> Von Mises (default)
//          stype = 2 -> Drucker-Prager
// Output:
...
H  = Ge(4);
phi = 0.0;
if stype==DruckerPrager & cols(Ge) == 5 then
  phi = Ge(5);
end 
