function [Ke] = keq4epe(Xe,Ge,Se,Ee,mtype)
...
// r = (0,0)
dN = [-1,1,1,-1;-1,-1,1,1]/4;
Jt = dN*Xe;
dN = Jt\dN;

W = [dN(1,1) dN(2,1) dN(1,2) dN(2,2) dN(1,3) dN(2,3) dN(1,4) dN(2,4)];
m = [1,1,0,0]';
I = eye(4,4);
...
if (mtype==DruckerPrager & cols(Ge) == 5) then
  phi = Ge(5);
end;
